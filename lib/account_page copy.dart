...
final defaultAddressId = _customer?['defaultAddress']?['id']?.toString();
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if ((_customer?['phone'] ?? '').toString().isNotEmpty) ...[
                      ...
                      Row(
                        children: [
                          ...
                          TextButton(
                            ...
                            child: const Text(
                              'Neu',
                              style: TextStyle(color: Color(0xFFDFC876)),
                            ),
                          ),
                        ],
                      ),
                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if ((a['company'] ?? '').toString().isNotEmpty)
                                Text(
                                  a['company'].toString(),
                                  style: const TextStyle(color: Colors.white70),
                                ),
                              ...
                              if ((a['address2'] ?? '').toString().isNotEmpty)
                                Text(
                                  a['address2'].toString(),
                                  style: const TextStyle(color: Colors.white70),
                                ),
                              ...
                              if ((a['country'] ?? '').toString().isNotEmpty)
                                Text(
                                  a['country'].toString(),
                                  style: const TextStyle(color: Colors.white70),
                                ),
...
if (a['id']?.toString() == defaultAddressId)
  Container(
    ...
    decoration: BoxDecoration(
      color: const Color(0xFFDFC876).withOpacity(0.14),
...
Wrap(
  ...
  children: [
    ...
    if (a['id']?.toString() != defaultAddressId)
      TextButton(
        onPressed: () => _setDefaultAddress(a['id'].toString()),
        child: const Text(
          'Als Standard',
          style: TextStyle(color: Color(0xFFDFC876)),
        ),
      ...
      child: const Text(
        ...
        style: TextStyle(color: Colors.redAccent),
                      ...
                      ...orders.map((edge) {
                        ...
                        final amount = total?['amount']?.toString() ?? '';
                        final currency = total?['currencyCode']?.toString() ?? '';
                        ...
                        return InkWell(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  order['name']?.toString() ?? 'Bestellung',
                                  style: const TextStyle(
                                    color: Color(0xFFDFC876),
                                    fontWeight: FontWeight.w800,
                                    fontSize: 16,
